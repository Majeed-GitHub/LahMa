...
class ModuleError(LahMaError):
    ...
    def __init__(self, module_name: str, message: str = "An error occurred in the module."):
...
class ApiError(LahMaError):
    ...
    def __init__(self, service_name: str, message: str = "External API interaction failed."):
